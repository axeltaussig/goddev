...
AgentName = Literal["gemini", "openai", "deepseek", "claude"]
...
class FileTask(BaseModel):
    ...
    required_exports: list[str] = Field(
        default_factory=list,
        description="Key function/class names this file MUST define (integration contract)",
    )
    imports_from: list[str] = Field(
        default_factory=list,
        description="Absolute paths of files this file imports from (for worker dep context)",
    )
